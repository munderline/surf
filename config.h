...
static char *fulluseragent  = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.122 Safari/537.36 Edg/80.0.361.62"; /* Or override the whole user agent string */
...
static Parameter defconfig[ParameterLast] = {
	...
	[MediaManualPlay]     =       { { .i = 1 },     },
	[Plugins]             =       { { .i = 1 },     },
	[PreferredLanguages]  =       { { .v = (char *[]){ "en_US", "es_AR", NULL } }, },
	[RunInFullscreen]     =       { { .i = 0 },     },
	[ScrollBars]          =       { { .i = 1 },     },
	[ShowIndicators]      =       { { .i = 1 },     },
	[SiteQuirks]          =       { { .i = 1 },     },
...
static Key keys[] = {
	...
	{ 0,                     GDK_KEY_i,      changemode, { .i = Insert },      Normal },
	{ 0,                     GDK_KEY_Escape, changemode, { 0 },                Insert },
	...
	{ 0,                     GDK_KEY_a,      togglecookiepolicy, { 0 } },
	{ 0,                     GDK_KEY_F11,    togglefullscreen, { 0 } },
	{ GDK_SHIFT_MASK,        GDK_KEY_i,      toggleinspector, { 0 } },
